...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           SubJet_nBHadrons[10];   //[nSubJet]
   Int_t           SubJet_nCHadrons[10];   //[nSubJet]
   UInt_t          nFatJet;
   Float_t         FatJet_LSmsoftdrop[100];   //[nFatJet]
   Float_t         FatJet_LSn2b1[100];   //[nFatJet]
   Float_t         FatJet_LSn3b1[100];   //[nFatJet]
   Float_t         FatJet_LSpt[100];   //[nFatJet]
   Float_t         FatJet_LSrawmsoftdrop[100];   //[nFatJet]
   Float_t         FatJet_LSsubJet1btagDeepB[100];   //[nFatJet]
   Float_t         FatJet_LSsubJet2btagDeepB[100];   //[nFatJet]
   Float_t         FatJet_LStau1[100];   //[nFatJet]
   Float_t         FatJet_LStau2[100];   //[nFatJet]
   Float_t         FatJet_LStau3[100];   //[nFatJet]
   Float_t         FatJet_LStau4[100];   //[nFatJet]
   Float_t         FatJet_area[100];   //[nFatJet]
   Float_t         FatJet_btagDDBvL[100];   //[nFatJet]
   Float_t         FatJet_btagDDCvB[100];   //[nFatJet]
   Float_t         FatJet_btagDDCvL[100];   //[nFatJet]
   Float_t         FatJet_btagHbb[100];   //[nFatJet]
   Float_t         FatJet_dRLep[100];   //[nFatJet]
   Float_t         FatJet_deepTagHbb[100];   //[nFatJet]
   Float_t         FatJet_deepTagHcc[100];   //[nFatJet]
   Float_t         FatJet_deepTagHqqqq[100];   //[nFatJet]
   Float_t         FatJet_deepTagMDHbb[100];   //[nFatJet]
   Float_t         FatJet_deepTagMDHcc[100];   //[nFatJet]
   Float_t         FatJet_deepTagMDHqqqq[100];   //[nFatJet]
   Float_t         FatJet_deepTagMDQCDbb[100];   //[nFatJet]
   Float_t         FatJet_deepTagMDQCDcc[100];   //[nFatJet]
   Float_t         FatJet_deepTagMDWcq[100];   //[nFatJet]
   Float_t         FatJet_deepTagMDWqq[100];   //[nFatJet]
   Float_t         FatJet_deepTagMDZbb[100];   //[nFatJet]
   Float_t         FatJet_deepTagMDZcc[100];   //[nFatJet]
   Float_t         FatJet_deepTagMDZqq[100];   //[nFatJet]
   Float_t         FatJet_deepTagQCDbb[100];   //[nFatJet]
   Float_t         FatJet_deepTagQCDcc[100];   //[nFatJet]
   Float_t         FatJet_deepTagWcq[100];   //[nFatJet]
   Float_t         FatJet_deepTagWqq[100];   //[nFatJet]
   Float_t         FatJet_deepTagZbb[100];   //[nFatJet]
   Float_t         FatJet_deepTagZcc[100];   //[nFatJet]
   Float_t         FatJet_deepTagZqq[100];   //[nFatJet]
   ...
   Float_t         FatJet_rawmsoftdrop[100];   //[nFatJet]
   ...
   Int_t           FatJet_electronIdx3SJ[100];   //[nFatJet]
   Int_t           FatJet_idLep[100];   //[nFatJet]
   Int_t           FatJet_jetId[100];   //[nFatJet]
   Int_t           FatJet_muonIdx3SJ[100];   //[nFatJet]
   Int_t           FatJet_nBHadrons[100];   //[nFatJet]
   Int_t           FatJet_nCHadrons[100];   //[nFatJet]
   Int_t           FatJet_nPFConstituents[100];   //[nFatJet]
   Int_t           FatJet_subJetIdx1[100];   //[nFatJet]
   Int_t           FatJet_subJetIdx2[100];   //[nFatJet]
   UInt_t          nElectron;
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[146];   //[nGenPart]
   Float_t         GenPart_mass[146];   //[nGenPart]
   Float_t         GenPart_phi[146];   //[nGenPart]
   Float_t         GenPart_pt[146];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[146];   //[nGenPart]
   Int_t           GenPart_pdgId[146];   //[nGenPart]
   Int_t           GenPart_status[146];   //[nGenPart]
   Int_t           GenPart_statusFlags[146];   //[nGenPart]
   ...
   UChar_t         LHE_NpLO;
   UInt_t          nLHEPart;
   Float_t         LHEPart_pt[2];   //[nLHEPart]
   Float_t         LHEPart_eta[2];   //[nLHEPart]
   Float_t         LHEPart_phi[2];   //[nLHEPart]
   Float_t         LHEPart_mass[2];   //[nLHEPart]
   Int_t           LHEPart_pdgId[2];   //[nLHEPart]
   Float_t         GenMET_phi;
   Float_t         GenMET_pt;
   ...
   Float_t         Photon_mvaIDV1[7];   //[nPhoton]
   ...
   Int_t           Photon_cutBasedBitmap[7];   //[nPhoton]
   Int_t           Photon_cutBasedV1Bitmap[7];   //[nPhoton]
